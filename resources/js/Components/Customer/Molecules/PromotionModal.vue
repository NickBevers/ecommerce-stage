                            ...
                            <form @submit.prevent="submit">
                                <div>
                                    <div class="flex w-full">
                                        <div
                                            class="flex h-12 w-14 items-center justify-center rounded-full bg-indigo-100 mr-4">
                                    ...
                                    <div class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
                                        <div class="sm:col-span-2">
                                            <label for="startDate" class="block text-sm font-medium text-gray-700">Start
                                                date*</label>
                                            <div class="mt-1">
                                                <input type="date" name="startDate" id="startDate" v-model="form.start_date"
                                        ...
                                        <div class="sm:col-span-2">
                                            <label for="end_date" class="block text-sm font-medium text-gray-700">End
                                                date</label>
                                            <div class="mt-1">
                                                <input type="date" name="endDate" id="end_date" v-model="form.end_date"
                                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
                                            </div>
                                        </div>

                                        <div class="sm:col-span-2">
                                            <label for="new_price" class="block text-sm font-medium text-gray-700">Promo
                                                price (excl vat)</label>
                                            <div class="mt-1">
                                        ...
                                        <div class="w-full sm:col-span-2">
                                            <input type="checkbox" name="applyToAll" id="apply_to_all" class="mr-2"
