...
<template>
  ...
  <div class="bg-white">
    ...
    <div v-else class="ml-0 px-4 pt-16 sm:px-6 sm:pt-24 lg:px-8 lg:pt-32 flex flex-col">
      <div class="">
        <h2 class="text-2xl font-bold tracking-tight text-gray-900">Customer Reviews</h2>
        <div class="mt-6">
          <h3 class="sr-only">Review data</h3>
      ...
      <div>
        <div class="flex flex-col items-center justify-center w-full">
          <img src="/assets/empty_review.svg" alt="empty" class="w-[150px] mb-4" />
          <h1 class="text-xl font-bold text-gray-500">There are no reviews yet, be the first to write one!</h1>
        </div>
      </div>
    </div>
  </div>
