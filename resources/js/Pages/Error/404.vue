...
<template>
    <main class="min-h-screen flex flex-row justify-center items-center bg-white px-6 py-24 sm:py-32 lg:px-8 h-screen">
        <div class="text-center">
            <p class="text-4xl font-semibold text-indigo-600">404</p>
            <h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Page not found</h1>
            <p class="mt-6 text-base leading-7 text-gray-600">Sorry, we couldn’t find the page/product you’re looking for.</p>
